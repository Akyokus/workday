        ...
        <div id="header-wrap">
            <div class="container">
                <div class="header-row">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="<?= site_url('index') ?>" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="<?= public_url('images/logo.png') ?>" alt="Canvas Logo"></a>
                        <a href="<?= site_url('index') ?>" class="retina-logo" data-dark-logo="images/logo-dark@2x.png"><img src="<?= public_url('images/logo@2x.png') ?>" alt="Canvas Logo"></a>
                    </div><!-- #logo end -->
